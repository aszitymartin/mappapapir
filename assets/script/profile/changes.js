...
function showPanel(evt, tabName) {
    ...
    $("#"+tabName).load('/includes/profile/'+tabName.split("-")[1]+'.php');
    document.getElementById(tabName).style.display = "flex";
}
const url__params = new URLSearchParams(window.location.search); const url__query__name = url__params.get("tab"); var accept__param = ["overview", "personal", "account", "face", "security", "password", "email", "credit", "invoice", "deactivate"];
