class sendAjaxRequest {
    ...
    getRequest (object) {
        return new Promise(resolve => {
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend : function () {
                    if (object['loaderContainer']) {
                        document.getElementById(object['loaderContainer']).innerHTML = `
                    ...
                    returnObjectConst.res = e;
                }
            });
            resolve(returnObjectConst);
        });
    }
    ...
    async sendRequest (object) {
        ...
        // return await this.getRequest(object);
    }
