...
var pages = document.getElementsByClassName('pr__item');
for (let i = 0; i < pages.length; i++) {
    $('#tab-'+pages[i].getAttribute('tab-data')).load('/admin/products/create/'+pages[i].getAttribute('tab-data')+'.php');
}
...
const url__params = new URLSearchParams(window.location.search); const url__query__name = url__params.get("tab"); var accept__param = ["general", "advanced", "reviews", "save", "import"];
