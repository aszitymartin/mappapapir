...
function showPanel(evt, tabName) {
    ...
    $("#"+tabName).load('/admin/includes/pages/'+tabName.split("-")[1]+'.php');
    document.getElementById(tabName).style.display = "flex";
}
const url__params = new URLSearchParams(window.location.search); const url__query__name = url__params.get("tab"); var accept__param = ["overview", "default", "products", "orders", "shipping", "feedbacks", "service", "users"];
