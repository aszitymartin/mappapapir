...
for (i = 0; i < l; i++) {
  ...
  for (j = 1; j < ll; j++) {
    c = document.createElement("DIV"); c.innerHTML = selElmnt.options[j].innerHTML; if (x[i].classList.contains('csts-select-fnc')) { c.setAttribute('onclick', '__setstatus('+selElmnt.options[j].value+')'); }
