                ...
                <div class="flex flex-row flex-align-c flex-justify-con-sb gap-05">
                    ...
                    <div class="flex flex-row">
                        <div class="flex flex-align-c pointer">
                            <?php
                                if (isset($uid)) {
                                    $bksql = "SELECT * FROM bookmarks WHERE uid = '". $uid ."' AND pid = '".$product_id."'";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (Number(respCode) === 410) {  // A statusz kod 410 (Sikeres torles) 
                            ...
                            else { var crbdspc__ind = document.createElement("div"); crbdspc__ind.id = "bspc__ind"; crbdspc__ind.classList = "badge badge-basket bold sidenav-badge flex flex-align-c flex-justify-con-c absolute box-shadow"; document.getElementById("deskBask").prepend(crbdspc__ind); crbdspc__ind.textContent = 1; }
