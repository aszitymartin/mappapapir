                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex flex-col flex-align-fs flex-justify-con-c gap-025 w-fa">
                                    <div class="flex flex-row gap-05 w-fa">
                                        ...
                                        <span id="vd-vc-ac-cn" onclick="validateVoucher()" class="splash flex flex-row flex-align-c w-fc gap-1 primary-bg primary-bg-hover border-soft-light padding-05 pointer user-select-none">
