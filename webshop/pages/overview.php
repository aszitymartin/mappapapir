...
<div id="overview-con">
    <div class="flex flex-col flex-align-c flex-justify-con-c gap-1 small text-muted user-select-none w-fa" id="product-loader">
        ...
        <span>Termék megjelenítése</span>
    </div>
</div>
<div class="hidden flex-row-d-col-m gap-1" id="product-overview-main">
...
<div class="hidden flex-col" id="prod-var-cus-con">
...
<div class="hidden flex-row-d-col-m gap-1" id="product-compare-section">
...
function loadProductInfo () {
    $.ajax({ enctype: "multipart/form-data", type: "POST", url: "/assets/php/webshop/info.php", data: urldata, dataType: 'json', contentType: false, processData: false,
        success: function(data) {
            ...
            document.getElementById('overview-con').remove();
            document.getElementById('product-overview-main').classList.replace('hidden', 'flex');
            document.getElementById('product-compare-section').classList.replace('hidden', 'flex');
            if (document.getElementById('prod-var-cus-con')) { document.getElementById('prod-var-cus-con').classList.replace('hidden', 'flex'); }
        }
    });
