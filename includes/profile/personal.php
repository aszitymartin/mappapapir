    ...
    <div class="flex flex-col w-fa gap-1 border-soft item-bg box-shadow padding-1">
        <div class="flex flex-row flex-align-c flex-justify-con-sb">
            ...
            <div class="flex flex-row gap-1">
                <span class="primary-bg primary-bg-hover border-soft-light padding-05-1 small-med pointer user-select-none flex flex-col flex-align-c flex-justify-con-c" id="prsv__personal">Mentés</span>
                <span class="text-primary pointer user-select-none small-med flex flex-col flex-align-c flex-justify-con-c" id="prcc__personal">Mégsem</span>
            </div>
