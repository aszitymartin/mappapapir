<div class="sidenav-theme">
    <div class="sidenav-header flex flec-row flex-align-c flex-justify-con-sb">
        <span class="flex flex-col">
            <span class="header_title_heading">Nyelv beállítása</span>
        </span>
        <span class="flex">
            <span class="text-primary" onclick="closeSettingMenu('language')">
    ...
    <div class="theme-body">
        <div class="theme-desc text-align-c">
            <span class="text-secondary text-small">Válassza ki az önnek megfelelő megjelenési a nyelvet, ami a továbbiakban az alapértelmezett nyelv lesz az oldalon.</span>
        </div>
