...
<div class="sidenav-theme">
    <div class="sidenav-header flex flec-row flex-align-c flex-justify-con-sb">
        ...
        <span class="flex">
            <span class="text-primary" onclick="closeSettingMenu('themes')">
            ...
            <script>
                if (!localStorage.getItem('theme')) {
                    ...
                    $('#theme-auto').click(function () {
                        localStorage.removeItem('theme');document.getElementById('theme-auto').checked = true;document.getElementById('theme-dark').checked = false;document.getElementById('theme-light').checked = false;const darkThemeMq = window.matchMedia('(prefers-color-scheme: light)');
                        if (darkThemeMq.matches) {html.dataset.theme = 'theme-light';
