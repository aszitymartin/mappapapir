...
<div class="sidenav-theme">
    ...
    <div class="theme-body" id="staff-body">
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data === 'true') {
                    ...
                    setTimeout(function () {location.href="/includes/staff/";document.getElementById('staff-auth-btton').classList.remove('pointer-event-none');}, 350);
                } else {
