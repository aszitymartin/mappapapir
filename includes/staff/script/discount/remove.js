    ...
    $.ajax({
        ...
        success: function(data) {
            if (data) {
                ...
                var form_data = new FormData();form_data.append("id", selectedId);
                $.ajax({
                    enctype: "multipart/form-data", type: "POST", url: "actions/discount/remove.php", data: form_data, dataType: 'json', contentType: false, processData: false,
                    success: function(data) {
                        ...
                        if (Number(data) === 30) { document.getElementById("prod-next").innerHTML = "Hiba"; closeAuth(); notificationSystem(1, 2, 0, 'Hiba', 'Ezt a termék nincs leértékelve.'); } 
