...
(3, 1, '4325df90sdf8', 'Mappa+ kártya', '6249', '2025-06-01', '961', 72200, '2022-06-14 12:43:40'),
...
INSERT INTO `def__news` (`id`, `uid`, `title`, `description`, `image`, `date`) VALUES
(1, 1, 'Hibajavítók', 'Hibajavító folyadékok, rollerek, tollak a hibák javításához. A folyadék gyors száradást és kiváló lefedettséget biztosít. A rollerek a gyakori felhasználók számára ideális megoldás. A toll kézhez álló apró hibák, kis területek, vonalak javításához.', '1.jpg', '2022-11-25 08:52:00'),
(2, 1, 'Írószerek', 'Írószerek és betétek több mint ezer típusból álló palettáját kínáljuk készletről a legolcsóbbtól a prémium termékekig bezárólag.', '2.jpg', '2022-11-25 08:55:07'),
(3, 1, 'Iratrendezők', 'Több mint 500 féle iratrendező, iratgyűjtő, iratpapucs, irattasak és iratrendezési kellék érhető el kínálatunkban széles színválasztékban.', '3.jpg', '2022-11-25 08:55:40'),
(4, 1, 'Adathordozók', 'Írható és újraírható CD, DVD, pendrive, memóriakártya többféle márkában, kiszerelésben és változatos tárolási kapacitással az Ön igényei szerint.', '4.jpg', '2022-11-25 08:56:07'),
(5, 1, 'Irodai kisgépek', 'Az irodai munkát, elsősorban a vágást, tűzést, lyukasztást segítő egyszerű eszközök. Megkönnyítik az iratok összefűzését, szétválasztását, tárolását, kényelmesebbé teszik a munkavégzést.', '5.jpg', '2022-11-25 08:56:47'),
(6, 1, 'Kreatív termékek', 'Tinták, kartonok, ragasztók, rajzeszközök és már kreatív kellékanyagok széles választékát találja meg szaküzletünkben és egyéni megrendelések beszerzését is vállaljuk.', '6.jpg', '2022-11-25 08:57:17'),
(7, 1, 'Irodaszerek', 'Bélyegzők, adathordozók, táskák, fémhálós termékek és további irodai kiegészítők elérhetőek webáruházunkban valamint szaküzletünkben azonnal, készletről.', '7.jpg', '2022-11-25 08:57:50');
...
(39, 79, 'apple-magic-mouse', 'irodai-egerek', 'irodai-eger,vezetek-nelkuli,nepszeru,uj-termek', 'apple', 32935, 0, 0, 5),
(40, 82, 'apple-magic-mouse', 'irodai-egerek', 'irodai-eger,vezetek-nelkuli,nepszeru,uj-termek', 'apple', 32935, 0, 0, 5);
...
(19, 1, 79, '<p>Napi szinten használom ezt az egeret. Imádom az érintési reakciót és a dizájnt. Egyes vélemények megjegyezték, hogy a kialakítás nem ergonómikus a hosszú távú használathoz, de úgy találtam, hogy ez nem így van. Ebben a félévben több tervezőórán veszek részt, és folyamatosan a laptopomon vagyok. Ezt a MacBook Pro-val használom otthon, és az iMac-en, amikor az irodában vagy az iskolában vagyok. Könnyen átvihető egyik eszközről a másikra. Körülbelül egy hete van nálam ez az egér, dobozból kivéve, és nem kellett töltenem. Tehát akár az asztalon váltogat, akár weboldalakat böngész, akár egy tervezési projektben merül el, ez az egér remekül működik.</p>', 5, NULL, '2022-09-17 16:06:47'),
...
ALTER TABLE `vouchers`
  ...
  ADD CONSTRAINT `vouchers_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `products` (`id`) ON DELETE CASCADE;
COMMIT;
