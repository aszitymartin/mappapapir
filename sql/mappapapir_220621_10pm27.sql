...
--
-- Host: localhost:3306
-- Generation Time: Jun 21, 2022 at 10:27 PM
...
ALTER TABLE `customers__card__deleted`
  ...
  ADD CONSTRAINT `customers__card__deleted_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `customers__card` (`cid`) ON DELETE CASCADE;
