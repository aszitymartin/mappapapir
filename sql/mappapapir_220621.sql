...
--
-- Host: localhost:3306
-- Generation Time: Jun 21, 2022 at 11:59 AM
...
(1, 1, 47, 'FOA221PIR', '2022-06-11 20:18:03'),
(2, 1, 49, 'KEN347FEK', '2022-06-11 20:18:04'),
(3, 1, 56, 'CAS112ROZ', '2022-06-20 10:44:53');
...
(1, 1, 55, 7, '2022-06-07 07:48:13'),
(2, 1, 54, 7, '2022-06-07 08:11:38'),
(3, 1, 53, 9, '2022-06-09 21:06:49'),
(4, 1, 56, 1, '2022-06-20 10:44:57'),
...
(3, 1, '4325df90sdf8', 'Mappa+ kártya', 6249, '2025-06-01', 961, 100000, '2022-06-14 12:43:40'),
(6, 1, '5f40c7429411', 'Mastercard', 5678, '2024-06-21', 129, 30000, '2022-06-21 08:35:12'),
(5, 8, 'deaeb46a9c01', 'Mappa+ kártya', 7037, '2025-06-20', 874, 100000, '2022-06-20 18:53:28');
...
(5, 8, 'deaeb46a9c01', 4100951181937037, 'Minta Misi', 'Virtuális kártya', 'Mappa Papír Kft.', '2022-06-20 18:53:28'),
...
(1, 1, '4325df90sdf8', '2022-06-13 22:00:00'),
(3, 8, 'deaeb46a9c01', '2022-06-19 22:00:00');
...
(1, 1, 10, 1, 1530, '2022-05-30 19:14:02'),
(2, 1, 58, 1, 55, '2022-05-30 19:16:11'),
(3, 1, 58, 1, 10870, '2022-05-30 19:31:29'),
(4, 1, 57, 1, 1945, '2022-05-31 15:24:58'),
(5, 1, 56, 5, 21625, '2022-05-31 15:25:23'),
(6, 1, 47, 1, 135, '2022-05-31 15:52:46');
...
(9, 1, 1, 'Ásztiy Martin', 'martinaszity@icloud.com', 'Kunfehértó', 'Kossuth utca 24', 6413, 307106140, '', '2022-05-30 19:14:02'),
(10, 2, 1, 'Ásztiy Martin', 'martinaszity@icloud.com', 'Kunfehértó', 'Kossuth utca 24', 6413, 307106140, '', '2022-05-30 19:16:11'),
(11, 3, 1, 'Ásztiy Martin', 'martinaszity@icloud.com', 'Kunfehértó', 'Kossuth utca 24', 6413, 307106140, '', '2022-05-30 19:31:29'),
(12, 4, 1, 'Ásztiy Martin', 'martinaszity@icloud.com', 'Kunfehértó', 'Kossuth utca 24', 6413, 307106140, '', '2022-05-31 15:24:58'),
(13, 5, 1, 'Ásztiy Martin', 'martinaszity@icloud.com', 'Kunfehértó', 'Kossuth utca 24', 6413, 307106140, '', '2022-05-31 15:25:24'),
(14, 6, 1, 'Ásztiy Martin', 'martinaszity@icloud.com', 'Kunfehértó', 'Kossuth utca 24', 6413, 307106140, '', '2022-05-31 15:52:46');
...
--
-- Table structure for table `reviews__old`
--

CREATE TABLE `reviews__old` (
  `id` int NOT NULL,
  `uid` int NOT NULL,
  `pid` int NOT NULL,
  `description` varchar(2048) COLLATE utf8mb4_hungarian_ci NOT NULL,
...
--
-- Dumping data for table `reviews__old`
--

INSERT INTO `reviews__old` (`id`, `uid`, `pid`, `description`, `stars`, `date`) VALUES
(1, 1, 29, 'A vélemény elküldésével hozzájárul ahhoz, hogy megadott e-mail címét a Mappa Papír Kft. (6400 Kiskunhalas, Kossuth utca 13-15; mappapapir.hu) adatkezelőként kezelje. Az adatkezelésről további tájékoztatások itt érhetőek el.A vélemény elküldésével hozzájárul ahhoz, hogy megadott e-mail címét a Mappa Papír Kft. (6400 Kiskunhalas, Kossuth utca 13-15; mappapapir.hu) adatkezelőként kezelje. Az adatkezelésről további tájékoztatások itt érhetőek el.', 4, '2022-06-20 15:19:31');
...
--
-- Indexes for table `reviews__old`
--
ALTER TABLE `reviews__old`
  ADD PRIMARY KEY (`id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `pid` (`pid`);
...
--
-- AUTO_INCREMENT for table `reviews__old`
--
ALTER TABLE `reviews__old`
...
--
-- Constraints for table `reviews__old`
--
ALTER TABLE `reviews__old`
  ADD CONSTRAINT `reviews__old_ibfk_1` FOREIGN KEY (`uid`) REFERENCES `customers` (`id`),
  ADD CONSTRAINT `reviews__old_ibfk_2` FOREIGN KEY (`pid`) REFERENCES `products` (`product_id`);
