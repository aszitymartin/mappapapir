...
--
-- Host: localhost:3306
-- Generation Time: May 17, 2022 at 07:34 PM
...
(18, 1, 10, 'EOF233FEH', '2022-05-10 10:31:21');
...
CREATE TABLE `cart` (
  ...
  `uid` int NOT NULL,
  `pid` int NOT NULL,
  `pcode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci NOT NULL,
  `added` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
(9, 10, 1, 'staff@mappapapir.hu', '2022-05-08 12:10:17');
...
(53, 'SIG221ZOL', 30, 'db', 'Signetta', 'Írószer', 'zöld', 'Golyóstoll', 'Eldobható golyóstoll biztonsági kupakkal, tinta színével megegyező tolltest. Vonalvastagság: 0,7 mm. Íráshossz: 2500 m.', 20, 'mm', 20, 'mm', 145, 'mm', '537755520220423151000.png', 55, 'huf', '2022-04-23 11:10:00'),
...
(1, 2, 10, 'First thing to mention is that to unlock cosmetics for your characters, you need to play the online modes. So, if you don’t have a Nintendo Online subscription, you are locked out of the progression system. There are no bosses or metals to earn in the game.', 2, '2022-05-14 12:56:34'),
...
(8, 1, 13, 'A vélemény elküldésével hozzájárul ahhoz, hogy megadott e-mail címét a Mappa Papír Kft. (6400 Kiskunhalas, Kossuth utca 13-15; mappapapir.hu) adatkezelőként kezelje. Az adatkezelésről további tájékoztatások itt érhetőek el.', 5, '2022-05-17 11:08:29');
